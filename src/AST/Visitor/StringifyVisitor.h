...
#ifndef AST__VISITOR__STRINGIFYVISITOR_H_
#define AST__VISITOR__STRINGIFYVISITOR_H_
...
namespace AST { namespace Visitor {
	...
	class StringifyVisitor: public Visitor {
		Text * getFunctionTextExpression(Fcn::FunctionCall * fcnExpr, const char * fcnName);
	public:
		StringifyVisitor();
...
#endif /* AST__VISITOR__STRINGIFYVISITOR_H_ */
